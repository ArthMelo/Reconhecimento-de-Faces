...
def recognize_face(train_images, train_labels, test_image, n_components=None, image_size=(100, 100)):
    ...
    # Imprimir as distâncias para depuração
...
# Exibir os rótulos e verificar se estão corretos
print("Rótulos de Treinamento:")
print(train_labels)

# Exemplo de uma imagem de teste (uma nova imagem de rosto)
...
# Exibir o nome da pessoa identificada
